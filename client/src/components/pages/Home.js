...
const Home = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-primary text-white py-5 mb-5 rounded-4 overflow-hidden">
        <div className="container px-5">
          <div className="row align-items-center">
            <div className="col-md-6 text-center text-md-start">
              <h1 className="display-4 fw-bold">Hammer Drop</h1>
              ...
              <div className="mt-4 d-flex justify-content-center justify-content-md-start">
                <Link to="/auctions" className="btn btn-light btn-lg me-3">
                  Browse Auctions
                </Link>
                {!isAuthenticated && (
            ...
            <div className="col-md-6 text-center mt-4 mt-md-0">
              <img
                src="https://cdn.pixabay.com/photo/2022/07/30/21/57/hammer-7354618_1280.jpg"
                alt="Hammer Drop"
      ...
      {/* Call to Action - Only visible to unauthenticated users */}
      {!isAuthenticated && (
